...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_style_model', type=str, default='model_zoo/chinese_iter60k_acc999.pth', help='pre-trained model for calculating Style Score')
    parser.add_argument('--pretrained_content_model', type=str, default='model_zoo/chinese_iter30k_acc95.pth',  help='pre-trained model for calculating Content Score')
